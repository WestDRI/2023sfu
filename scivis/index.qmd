...
1. [Download today's materials](https://transfer.sh/pMnOTpgEwc/paraview.zip) as a single ZIP file with slides
(two PDFs), data and scripts inside. Unpack it where you can find it on your computer.
