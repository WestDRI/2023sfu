...
1. [Download today's materials](https://transfer.sh/pMnOTpgEwc/paraview.zip) (in case of problems here is an
[alternative link](https://www.dropbox.com/s/gttqb8n6xikzzvn/paraview.zip?dl=0)) as a single ZIP file with
slides (two PDFs), data and scripts inside. Unpack it where you can find it on your computer.

<!-- NextCloud link https://bit.ly/paraviewzipp -->
